			...
			<div id="header-wrapper">
				...
				<!-- Header -->
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="#">Opções da Avalição Física</a></h1>
							<p></p>
                            <div class="bv">
<?php 
...
?>
       ...
       <div class="area_pesquisa">
		...
		<h2>Avaliações Físicas Cadastradas</h2>
		<?php
			...
			if(isset($_POST['codigoAvaliacaoFisica'])){
				$codigoAvaliacaoFisica = $_POST['codigoAvaliacaoFisica'];
				
				/*SQL para fazer pesquisa no BD*/
				$query = "SELECT * FROM avaliacaofisica WHERE codigoAvaliacaoFisica = ?";
				$stm = $db->prepare($query);
				$stm ->bindParam(1, $codigoAvaliacaoFisica);
			}	
			else  {			
				/*SQL para fazer pesquisa no BD*/
				$query = "SELECT * FROM avalicaofisica";
				$stm = $db->prepare($query);
			}

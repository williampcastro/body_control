					...
					<section id="features" class="container">
						<div class="row">
                            <div class="formulario">
								<form method="post" action="avaliacao_fisica/salva.php">
<label>Código do Aluno:</label>
<input name="codigoAluno" /></br>
<label>Peso:</label>
<input name="pesoAluno"></br>
<label>Estatura:</label>
<input name="estaturaAluno"></br>
<label>Data da Avaliação:</label>
<input name="dataAvalicaoAluno" /></br>
<label>Medida do Torax:</label>
<input name="medidaTorax" /></br>
<label>Medida do Abdomen:</label>
<input name="medidaAbdomen"></br>
<label>Medida do Antebraço:</label>
<input name="medidaAntebraco"></br>
<label>Medida do Braço:</label>
<input name="medidaBraco"></br>
<label>Medida da Coxa:</label>
<input name="medidaCoxa"></br>
<label>Medida da Panturrilha:</label>
<input name="medidaPanturrilha"></br>
<label>Medida da Cintura:</label>
<input name="medidaCintura"></br>
<label>Medida do Quadril:</label>
<input name="medidaQuadril"></br>
<label>Medida da Dobra Cutânea Torax:</label>
<input name="medidaDobraCutaneaTorax"></br>
<label>Medida da Dobra Cutânea Abdomen:</label>
<input name="medidaDobraCutaneaAbdomen"></br>
<label>Medida da Dobra Cutânea Coxa:</label>
<input name="medidaDobraCutaneaCoxa">	</br>
<label>Medida da Dobra Cutânea Triceps:</label>
<input name="medidaDobraCutaneaTriceps">	</br>
<label>Medida da Dobra Cutânea SupaIliaca:</label>
<input name="medidaDobraCutaneaSupraIliaca">	</br>
<label>Porcentagem de Gordura:</label>
<input name="porcentagemGorduraAluno">	</br>
<label>Peso Magro:</label>
<input name="pesoMagroAluno">	</br>
<label>Peso Gordo:</label>
<input name="pesoGordoAluno">	</br>
<label>Peso Ideal:</label>
<input name="pesoDesejavelAluno">	</br>

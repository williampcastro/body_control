...
<label>Nome:</label>
<input name="nomeAluno" /></br>
<label>Data de Inclusão:</label>
<input name="dataInclusaoAluno"></br>
<label class="se">Sexo:</label>
<input class="sexo" type="radio" name="sexoAluno" value="M" ><label class="sex">Masculino</label>	
<input class="sexo" type="radio" name="sexoAluno" value="F" ><label class="sex">Feminino</label></br>
<label>Telefone:</label>
<input name="telefoneAluno" /></br>
<label>Celular:</label>
<input name="celularAluno" /></br>
<label>Email:</label>
<input name="emailAluno"></br>
<label>Endereço:</label>
<input name="enderecoAluno"></br>
<label>Complemento:</label>
<input name="complementoAluno"></br>
<label>Bairro:</label>
<input name="bairroAluno"></br>
<label>Cep:</label>
<input name="cepAluno"></br>
<label>Cidade:</label>
<input name="cidadeAluno"></br>
<label>Estado:</label>
<input name="estadoAluno"></br>
<label>CPF:</label>
<input name="cpfAluno"></br>
<label>RG:</label>
<input name="rgAluno"></br>
<label>Estado Civil:</label>
<input name="estadoCivilAluno"></br>
<label>Data de Nascimento:</label>
<input name="dataNascimentoAluno"></br>
<label>Nome do Pai:</label>
<input name="nomePaiAluno"></br>
<label>Nome da Mãe:</label>
<input name="nomeMaeAluno">	</br>

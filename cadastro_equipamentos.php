			...
			<div id="header-wrapper">
				...
				<!-- Header -->
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="#">Cadastro Equipamentos</a></h1>
							<p></p>
							<div class="bv">
<?php
//Inclui o arquivo de verificação de sessão.
					...
					<section id="features" class="container">
						<div class="row">
                            <div class="formulario">
								<form method="post" action="equipamento/salva.php">
<label>Nome do Equipamnto</label>
<input name="nomeEquipamento" /></br>
<label>Data da Compra:</label>
<input name="dataCompra"></br>

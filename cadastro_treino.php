			...
			<div id="header-wrapper">
				...
				<!-- Header -->
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="#">Cadastro Treino</a></h1>
							<p></p>
							<div class="bv">
<?php
//Inclui o arquivo de verificação de sessão.
					...
					<section id="features" class="container">
						<div class="row">
                            <div class="formulario">
								<form method="post" action="treino/salva.php">
<label>Código do Aluno:</label>
<input name="codigoAluno" /></br>
<label>Data Ínicio do Treino:</label>
<input name="dataInicioTreino"></br>
<label>Data Término do Treino:</label>
<input name="dataTerminoTreino"></br>
<label>Número de Repetições:</label>
<input name="repeticoes" /></br>

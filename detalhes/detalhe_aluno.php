...
<html>
	...
	<body class="homepage">
			...
			<div id="header-wrapper">
				...
				<!-- Header -->
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="#">Pesquisa de Alunos</a></h1>
							<p></p>
                            <div class="bv">
</div>
       ...
       <div class="area_pesquisa">
		<form method="post" action="pesquisa_aluno.php">
		...
		<?php
			...
			if ($stm -> execute()){
						...
						print"<td>$nomePaiAluno</td>";
						print"<td>$nomeMaeAluno</td>";
						print"<td><a href='../alunos.php'>Voltar</a></td></tr>";
									}
					print "</table>";

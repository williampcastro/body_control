			...
			<div id="header-wrapper">
				...
				<!-- Header -->
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="#">Opações do Equipamento</a></h1>
							<p></p>
                            <div class="bv">
<?php 
...
?>
						...
						<!-- Nav -->
							<nav id="nav">
                                    ...
                                    <ul>
											...
											<li><a href="pesquisa.php">Equipamentos</a></li>
       ...
       <div class="area_pesquisa">
		<form method="post" action="pesquisa.php">
			...
			<label id='lpesquisa'>Digite o nome do Equipamentos:</label>
		...
		<?php
			...
			$nomeEquipamento = '';
			if(isset($_POST['nomeEquipamento'])){
				$nomeAluno = $_POST['nomeEquipamento'];
			}
			...
			$query = "SELECT * FROM equipamentos WHERE nomeEquipamento LIKE '%$nomeEquipamento%'";
			...
			if ($stm -> execute()){
						...
						print"<td><a href='delete.php?codigoEquipamento=$codigoEquipamento'>Deletar</a> | ";
				...
				print"<h3>Erro ao listar equipamentos</h3>";
			}

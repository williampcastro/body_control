			...
			<div id="header-wrapper">
				...
				<!-- Header -->
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="#">Cadastro do Equipamento</a></h1>
							<p></p>
                            <div class="bv">
<?php 
						...
						<div class="row">
                            <div class="ok">
								<?php
									...
									$query = "INSERT INTO equipamentos ( nomeEquipamento, dataCompra
												) VALUES (?,?)";
									...
									/* Executando QUERY */
									if ($stm->execute()){
									print '<p>Equipamento cadastrado com sucesso!</p>';
									}
									
									else{
									print'<p>Erro ao Cadastrar o Equipamento</p>';
									}
																
								?>
								</br><a href='../cadastro_equipamentos.php'>Clique aqui, para cadastrar outro Equipamento!</a>
							</div>
						</div>
					</section>

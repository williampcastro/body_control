			...
			<div id="header-wrapper">
				...
				<!-- Header -->
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="#">Alterar Fichas Eq. de Treino</a></h1>
							<p></p>
                            <div class="bv">
<?php 
...
?>
       ...
       <h2>Pesquisa de Ficha de Equipamento de Treino</h2>
       <div class="area_pesquisa">
		<form method="post" action="pesquisa.php">
        	
			<label id='lpesquisa'>Digite o código da Ficha de Equipamento de Treino:</label>
			<input id='ipesquisa' type="text" name="codigo" />
...
?>
		...
		<h2>Editando Fichas de Equipamentos de Treino</h2></br>
		<form method="POST" action="atualiza.php">
        	<div class="formulario_alteracao">
 
			<?php print "<input type='hidden' name='codigo' value='$codigo'/>";?>
			
            <label>Código Ficha de Treino:</label>
            <?php print "<input type='text' name='codigoFicha' value='$codigoFicha'/>"; ?></br>
            
            <label>Código do Equipamento:</label>
            <?php print "<input type='text' name='codigoEquipamento' value='$codigoEquipamento'/>";?></br>

           
			<button id="submit_atualiza" type="submit"></button> 
			
			<h2>Listagem das Fichas de Equipamentos de Treino</h2>
		<?php
			/*Conexão com o BD*/
			...
			/*SQL de consulta*/
			$query = "select * from fichaequipamentodetreino";
			$stm = $db->prepare($query);
			if ($stm -> execute()){
			
						
						print"<table border style='border-collapse:collapse'>";
						print"<tr class='lista'><th>CÓDIGO</th>";
						print"<th>CÓDIGO DA FICHA DE TREINO</th>";
						print"<th>CÓDIGO DO EQUIPAMENTO</th>";
						...
						print"<td>$codigoFicha</td>";
						print"<td>$codigoEquipamento</td>";
						print"<td><a href='delete.php?codigo=$codigo'>Delete</a> | ";
						print"<a href='edita.php?codigo=$codigo&codigoFicha=$codigoFicha&codigoEquipamento=$codigoEquipamento&'>";
				...
				print"<h3>Erro ao listar Fichas de Equipamentos de Treino</h3>";
			}
		?>
		</form>
	</div>

			...
			<div id="header-wrapper">
				...
				<!-- Header -->
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="#">Alterar Fichas de Treino</a></h1>
							<p></p>
                            <div class="bv">
<?php 
...
<?php
	...
	$dataInicioTreino = $_GET ['dataInicioTreino'];
	$dataTerminoTreino = $_GET ['dataTerminoTreino'];
	$repeticoes = $_GET ['repeticoes'];
	$series = $_GET ['series'];
?>


		<h2>Editando Ficha de Treino</h2></br>
		<form method="POST" action="atualiza.php">
        	<div class="formulario_alteracao">
 
			<?php print "<input type='hidden' name='codigoFicha' value='$codigoFicha'/>";?>
			
            <label>Código do Aluno:</label>
            <?php print "<input type='text' name='codigoAluno' value='$codigoAluno'/>"; ?></br>
            
            <label>Data do Ínicio do Treino:</label>
            <?php print "<input type='text' name='dataInicioTreino' value='$dataInicioTreino'/>";?></br>
            
            <label>Data do Término do Treino:</label>
            <?php print "<input type='text' name='dataTerminoTreino' value='$dataTerminoTreino'/>";?></br>
           
            <label>Repetições:</label>
            <?php print "<input type='text' name='repeticoes' value='$repeticoes'/>";?></br>
           
            <label>Séries:</label>
            <?php print "<input type='text' name='series' value='$series'/>";?></br>
           
			<button id="submit_atualiza" type="submit"></button> 
			
			<h2>Listagem das Fichas de Treino</h2>
		<?php
			/*Conexão com o BD*/
			...
			if ($stm -> execute()){
						...
						print"<td>$series</td>";
						print"<td><a href='delete.php?codigoFicha=$codigoFicha'>Delete</a> | ";
						print"<a href='edita.php?codigoFicha=$codigoFicha&codigoAluno=$codigoAluno&dataInicioTreino=$dataInicioTreino&dataTerminoTreino=$dataTerminoTreino&repeticoes=$repeticoes&series=$series'>";

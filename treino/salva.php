			...
			<div id="header-wrapper">
				...
				<!-- Header -->
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="#">Cadastro do Treino</a></h1>
							<p></p>
                            <div class="bv">
<?php 
...
?>
	...
	$query = "INSERT INTO fichasdetreino ( codigoAluno, dataInicioTreino, dataTerminoTreino, repeticoes, series
				) VALUES (?,?,?,?,?)";
	...
	/* Executando QUERY */
	if ($stm->execute()){
	print '<p>Ficha de Treino cadastrada com sucesso!</p>';
	}
	
	else{
	print'<p>Erro ao cadastrar Ficha de Treino</p>';
					print_r($stm->errorInfo());
	}
								
?>
</br><a href='../cadastro_treino.php'>Clique aqui, para cadastrar outra Ficha de Treino!</a>
							</div>
						</div>
					</section>
